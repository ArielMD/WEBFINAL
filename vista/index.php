        ...
        foreach($lista as $fila){
          ...
          <div class="col-lg-4">
              ...
              <p>
                  ...
                  <a href="agregar.php?art='.$fila["Articulos_a_Id"].'"> <button type="button" class="btn btn-info" data-toggle="tooltip" data-placement="bottom" title="Añadir este producto al carrito">Al carrito <i class="fa fa-shopping-cart"></i>
                      </button></a>
